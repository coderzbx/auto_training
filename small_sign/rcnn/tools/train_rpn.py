...
from ..core.prefetch_iter import PrefetchIter
...
def train_rpn(network, dataset, image_set, root_path, dataset_path,
    ...
    use_prefetch = False
    if use_prefetch:
      train_data = PrefetchIter(train_data, 4, 200)
      train_data.reset()
    ...
    if not use_prefetch:
      ...
      max_data_shape, max_label_shape = train_data._iter.infer_shape(max_data_shape)
