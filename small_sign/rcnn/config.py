...
dataset.KdTrafficSign = edict()
dataset.KdTrafficSign.PIXEL_MEANS = np.array([118.366, 112.797, 106.641])
dataset.KdTrafficSign.NUM_CLASSES = 7
dataset.KdTrafficSign.SCALES = [(2048, 2448)]
dataset.KdTrafficSign.ANCHOR_SCALES = (8,)
dataset.KdTrafficSign.ANCHOR_RATIOS = (0.5, 1, 1.6)
dataset.KdTrafficSign.NUM_ANCHORS = len(dataset.KdTrafficSign.ANCHOR_SCALES) * len(dataset.KdTrafficSign.ANCHOR_RATIOS)
dataset.KdTrafficSign.CLASS_ID = [0, 1, 2, 3, 4, 5, 6]
