...
class ModelMaskrcnn(object):
    ...
    def __init__(self, gpu_id):
        ...
        # image_path = "/data/deeplearning/dataset/534_20180223134021638/534_20180223134029926965.jpg"
        # with open(image_path, "rb") as f:
        #     image_data = f.read()
        # self.do(image_data=image_data, dest_file=None)
        # _end = time.time()
    ...
    def do(self, image_data, dest_file=None):
        ...
        try:
            ...
            # blank_image.save(pred_data, format="PNG")
