...
self_road_chn_labels = {
    ...
    Label(u'停靠站标线', 10, 15, 'SlowNet', 10, True, False, (240, 128, 128)),
    Label(u'出入口标线', 11, 6, 'InOut', 11, True, False, (128, 128, 0)),
    Label(u'文字符号类', 12, 7, 'FishLane', 12, True, False, (0, 0, 255)),
    Label(u'导流线（鱼刺线）', 13, 8, 'FishLane', 13, True, False, (0, 255, 0)),
    Label(u'停止网格标线', 14, 9, 'StopNet', 14, True, False, (255, 255, 0)),
    Label(u'车距确认线', 15, 10, 'Sidewalk', 15, True, False, (255, 128, 255)),
    Label(u'道路', 16, 11, 'Road', 16, True, False, (192, 192, 192)),
    Label(u'其他', 17, 12, 'Other', 17, True, False, (64, 64, 32)),
    Label(u'车辆及路面上其他物体', 18, 12, 'Other', 18, True, False, (128, 0, 0)),
    Label(u'Ignore', 19, 13, 'Other', 19, True, False, (0, 0, 0)),
}
...
self_road_simple_labels = {
    ...
    Label1(10, 10,   (240, 128, 128),    u'停靠站标线'),
    Label1(11, 11,   (128, 128, 0),      u'出入口标线'),
    Label1(12, 12,   (0, 0, 255),        u'文字符号类'),
    Label1(13, 13,   (0, 255, 0),        u'导流线（鱼刺线）'),
    Label1(14, 14,   (255, 255, 0),      u'停止网格标线'),
    Label1(15, 15,   (255, 128, 255),    u'车距确认线'),
    Label1(16, 16,   (192, 192, 192),    u'道路'),
    Label1(17, 17,   (64, 64, 32),       u'其他'),
    Label1(18, 18,   (128, 0, 0),        u'车辆及路面上其他物体'),
    Label1(19, 19,   (0, 0, 0),          u'Ignore'),
}
